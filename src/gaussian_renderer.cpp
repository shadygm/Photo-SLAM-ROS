...
GaussianRenderer::render(std::shared_ptr<GaussianKeyframe> viewpoint_camera,
                         ...
                         torch::Tensor &override_color, float scaling_modifier,
  ...
  GaussianRasterizationSettings raster_settings(
      ...
      viewpoint_camera->camera_center_, false);
   ...
   */
  bool has_scales = false, has_rotations = false, has_cov3D_precomp = false;
  ...
  torch::Tensor shs, colors_precomp;
  ...
  auto rasterizer_result =
      rasterizer.forward(means3D, means2D, opacity, has_shs, has_color_precomp,
                         has_scales, has_rotations, has_cov3D_precomp, shs,
                         colors_precomp, scales, rotations, cov3D_precomp);
