...
static const _SingleGaussian_type_support_symbol_names_t _SingleGaussian_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gaussian_interface, msg, SingleGaussian)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gaussian_interface, msg, SingleGaussian)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gaussian_interface, msg, SingleGaussian)() {
  return &::gaussian_interface::msg::rosidl_typesupport_c::SingleGaussian_message_type_support_handle;
}
